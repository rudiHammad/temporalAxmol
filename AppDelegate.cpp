...
//static ax::Size designResolutionSize = ax::Size(970, 540);
...
bool AppDelegate::applicationDidFinishLaunching()
{
    ...
    (AX_TARGET_PLATFORM == AX_PLATFORM_LINUX)
        ...
        glView = GLViewImpl::createWithRect(
            "PlatforLearning", ax::Rect(0, 0, designResolutionSize.width * 3, designResolutionSize.height * 3));        // * 3 to be HD
        
#else
        glView = GLViewImpl::create("PlatforLearning");
#endif
